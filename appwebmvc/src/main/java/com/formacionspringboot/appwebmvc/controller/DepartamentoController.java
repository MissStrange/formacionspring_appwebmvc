...
public class DepartamentoController {
	...
	public String listarDepartamentos(Model model) {
		...
		model.addAttribute("departamentos", servicio.listarTodosDepartamentos());
	...
	public String editarDepartamento(@PathVariable Long id, @ModelAttribute("departamentoKey") Departamento departamento, Model modelo) {
